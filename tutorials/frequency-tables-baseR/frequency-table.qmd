...
We aquired a dataset containing the 1000 songs and information about them. After importing the data to R, we can look at the dataset with the following command:
